...
class PageRenderTests(unittest.TestCase):
    ...
    def test_timer_dashboard_page_groups_devices_by_controller_and_edits_as_one_schedule(self):
        ...
        self.assertIn("function controllerScheduleForm(role, items) {", html)
        ...
        self.assertIn('data-role="${escapeHtml(role)}"', html)
        ...
        self.assertIn('editor.innerHTML = controllerScheduleForm(role, items);', html)
        self.assertIn('const editor = document.createElement("div");', html)
        self.assertIn('const form = editor.querySelector("#timer-schedule-form");', html)
