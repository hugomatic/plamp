...
class PageRenderTests(unittest.TestCase):
    ...
    def test_timer_dashboard_page_groups_devices_by_controller_and_edits_as_one_schedule(self):
        ...
        self.assertIn('actions.innerHTML = controllerScheduleForm(role, items);', html)
        self.assertIn('const actions = document.createElement("div");', html)
        self.assertIn('const form = actions.querySelector("#timer-schedule-form");', html)
        ...
        self.assertNotIn('className = "controller-editor"', html)
